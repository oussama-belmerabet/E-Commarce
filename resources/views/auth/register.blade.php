                            ...
                            <div class="login_wrap widget-taber-content p-30 background-white border-radius-5">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group">
                                                <input type="number" required="" name="phone" placeholder="phone" :value="old('phone')" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" name="address" placeholder="address" :value="old('address')" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="number" required="" name="age" placeholder="age" :value="old('age')" required>
                                            </div>
                                            <div class="form-group">
